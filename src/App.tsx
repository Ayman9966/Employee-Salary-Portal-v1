...
export default function App() {
  ...
  useEffect(() => {
    ...
    const manifest = {
      ...
      icons: [
        {
          src: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%23003d9b'%3E%3Cpath d='M3 3h18v18H3z'/%3E%3C/svg%3E",
          sizes: "192x192",
          type: "image/svg+xml",
        },
        {
    ...
    if (!appleIcon) {
      ...
      appleIcon.setAttribute(
        "href",
        "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%23003d9b'%3E%3Cpath d='M3 3h18v18H3z'/%3E%3C/svg%3E",
      );
